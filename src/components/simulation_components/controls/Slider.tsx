import type { SliderProps } from './controlTypes';

export interface SliderComponent extends React.FC<SliderProps> {
  (props: SliderProps): React.ReactElement;
}

function Slider({ label, value, onChange, min, max, step }: SliderProps): React.ReactElement {
  return (
    <div className="mb-4">
