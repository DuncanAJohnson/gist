...
flowchart LR
  ...
  subgraph RAMPPHASES["7. Ramps & tracks (env shapes)"]
    ...
    RT7["R6 · bench (flat lane / table / ledge)<br/>third seatOn target · from/to span · µ 0<br/>slab-only, always static · then bench.y slider<br/>eval bench B23 (proposed)<br/><b>SCOPED 2026-09-15</b> · ahead of R4/R5 + wishlist §1"]
    RT1 --> RT2 --> RT3 --> RT4
    RT2 --> RT5
    RT3 --> RT7
    RT3 -.reframed, no longer ramp-scoped.-> RT6
    RT7 -.sequenced ahead of.-> RT6
  end
  ...
  class CC1,CC7,RT5,RT6,RT7 proposed;
`;
