...
- ❌ NEVER `"velocity"`, `"position"`, `"acceleration"`, or `"appliedForce"` alone — these are 2D vectors and the UI will crash trying to render them. (To show speed, use `"velocity.magnitude"`, NOT two separate axis readouts.)
