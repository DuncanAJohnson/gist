...
4. Set physics fields appropriate to the object's role: `velocity`, `acceleration` (rare — gravity is usually enough, and see the chapter rule below), `mass`, `restitution`, `friction`, `isStatic`, `angle`, `angularVelocity`, etc.
