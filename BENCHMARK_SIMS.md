...
| 7 | Newton's 2nd law, 1D | **B5** | `applied-force-1d` | 🟡 UNBLOCKED 2026-08-09 | *was* 🔴: no impulse API. `applyImpulse` + per-step delivery shipped; owes the schema field, the B5 scene, and scoring |
...
#### Cell 7 — Newton's 2nd law, 1D (B5) 🟡 **UNBLOCKED 2026-08-09** · est. medium — the refactor's Phase 1 is done; a schema field and a scene remain
